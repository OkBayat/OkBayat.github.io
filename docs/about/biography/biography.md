...
Over approximately a decade, he also led [FamilyLink](/family-link), a K2-supported family-support initiative that distributed clothing and other practical assistance, worked with mothers and other caregivers, and explored training and livelihood support. The project paused in 2026 after its K2-dependent funding model became unsustainable. Its public record now separates reported activity from verified outcomes and documents what would be required for a responsible return.
...
OkBayat.com is the public record of these activities: essays, open questions, research and field notes, reading notes, attributed translations, software projects, social-impact project records, program records, and lessons from building organizations.

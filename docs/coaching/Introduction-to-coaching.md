...
### کوچینگ حرفهای چیست؟
فدراسیون بین‌المللی کوچینگ، سازمانی حرفه‌ای است که برای تمامی کوچ‌ها - به عنوان عضوی از ICF - دستورالعمل‌هایی را تنظیم کرده است. برای کسب اطلاعات بیشتر میتوانید به سایت ICF به نشانی (https://www.coachfederation.org)[www.coachfederation.org] مراجعه كنيد.
...
### اصل اول - موقتاً (آگاهانه) قضاوت نكنيد:

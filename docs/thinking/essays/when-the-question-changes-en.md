---
layout: default
title: "When the Question Changes, the Organization Changes: From a Money Worldview to a Commitment Beyond the Self"
description: "How a shift in worldview and leadership inquiry can reveal new possibilities, strengthen team learning, and produce different business models."
parent: Essays
direction: ltr
lang: en
locale: en_US
...
tags:
  ...
  - value-creation
sitemap: true
permalink: /thinking/essays/when-the-question-changes-en
---

# When the Question Changes, the Organization Changes
{: .no_toc }

{ From a money worldview to a commitment beyond the self | fs-6 }

[نسخه‌ی فارسی](/thinking/essays/when-the-question-changes-fa)
...
[Amy Edmondson’s classic research](https://doi.org/10.2307/2666999) on psychological safety found that a shared belief that a team is safe for interpersonal risk taking was associated with team learning behaviors such as asking questions, seeking help, discussing errors, and experimenting. [Adam Grant’s research](https://doi.org/10.1037/0021-9010.93.1.108) on task significance also suggests that seeing the effect of one’s work on beneficiaries can, under some conditions and through relational mechanisms, improve performance. A commitment beyond the self does not guarantee either result, but it can provide a shared reason to build the conditions that support them.
...
A commitment beyond the self does not mean erasing oneself or tolerating harm. A shared future cannot be created unilaterally where consent, safety, and mutual responsibility are absent. Sometimes seeing reality and preserving dignity requires ending the relationship. I develop that boundary more fully in [Acceptance Before Change](/thinking/essays/acceptance-before-change-en).

...
{ [English version](/thinking/essays/acceptance-before-change-en) | ltr }
...
در برنامه‌ی [چیرگی بر زندگی](/human-transformation/practice-programs/mastery-for-life) و گفت‌وگوهای کوچینگ، از مفهومی استفاده کرده‌ام که آن را «کامل‌شدن» می‌نامم.
...
این گزاره نیز برای تبدیل‌شدن به ادعایی قوی‌تر، به مشاهده و اندازه‌گیری دقیق‌تر در زمان‌ها و محیط‌های متفاوت نیاز دارد. بخشی از [برنامه‌ی پژوهشی تحول انسان](/human-transformation/research-agenda) من دقیقاً حول همین پرسش شکل گرفته است: چه چیزی از یک تغییر، بعد از عوض‌شدن بافتار باقی می‌ماند؟

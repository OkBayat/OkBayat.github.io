...
- [Building Effective Agents](https://www.anthropic.com/engineering/building-effective-agents) — the distinction between predefined workflows and dynamically directed agents, along with routing, chaining, evaluator, and orchestrator patterns.

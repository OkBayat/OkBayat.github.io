...
status: working-note
project: vocora
permalink: /thinking/research-notes/retrieval-practice
categories:
  - thinking
  - research-notes
tags:
...
1. ask for an answer before revealing it;
2. give clear corrective feedback after an error;
3. avoid counting immediate retries as independent evidence of retention;
4. measure recall again after a meaningful delay;
5. distinguish a retrieved word from a permanently learned word;
6. add meaning and context without turning every prompt into passive recognition.

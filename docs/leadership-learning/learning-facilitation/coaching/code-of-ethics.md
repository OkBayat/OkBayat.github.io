...
{ **منبع ۲:** اصول اخلاقی [ICF](https://coachingfederation.org/credentialing/coaching-ethics/icf-code-of-ethics/) | sub }
{ **مترجم:** محمد بیات | sub }
...
فهرست زیر، معیارهاى اخلاقى ارایه شده توسط ICF براى کوچ‌ها است که در کار حرفه‌ای خود دنبال نمایند. این استانداردها مرتبا به روز می‌شوند، پس اطمینان حاصل نمایید که به طور منظم آن‌ها را از سایت [ICF](https://coachingfederation.org/credentialing/coaching-ethics/icf-code-of-ethics/) مرور وبررسی می‌کنید.

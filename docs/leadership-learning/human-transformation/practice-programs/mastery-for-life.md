...
این پرسش‌ها در [برنامه‌ی پژوهشی تحول انسان](/research/agenda) با دامنه‌ی گسترده‌تری ثبت شده‌اند.
...
9. ثبت تغییرات طراحی در همین سابقه‌ی برنامه و پیوند آن‌ها با [برنامه‌ی پژوهشی تحول انسان](/research/agenda-fa).

...
parent: Resources
direction: rtl
permalink: /work/leadership-learning/leadership/resources/clearing
---
...
شما - آن کسی که زندگی برایش "[بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here)" ظهور پیدا می‌کند - نه "اینجا" قرار گرفته است و نه "آنجا".

شما، آن کسی که زندگی برایش [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) ظهور پیدا می‌کند، **عرصه‌ی روشنگاه** هستید -عرصه‌ی روشنگاهی که زندگی، در آن ظهور پیدا می‌کند. یعنی شما عرصه‌ی روشنگاهی هستید که دنیا، دیگران و آن کسی که وقتی می‌گویید "من" یا "منم" به آن اشاره می‌کنید، در آن ظهور پیدا می‌کند. همان‌طور که مارتین‌هایدگر که یکی از دو فیلسوف بزرگ قرن بیستم است، می‌گوید: بودن برای بشر، "بودن-در-این-دنیا" است. <sub>(هایدگر ۱۹۶۲)</sub>

با اتخاذ ایستمانِ [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) برای خودتان، بیرون در تمام دنیا، و نه فقط در اتاق مراقبه، با سطح آگاهیِ بالا عمل می‌کنید. و بودن خودتان را عملاً [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) تجربه خواهید کرد، و با زندگی در آن جایی که زندگی عملاً اتفاق می‌افتد، تعامل می‌کنید.
...
کدام درست است، یعنی کدام یک را باید باور کنم: من **درون-اینجا** هستم یا من **[بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here)** هستم؟ هیچ یک از این‌ها به‌ عنوان یک فکت درست نیست، یعنی هیچ کدام به صورت [برون‌آخته](/work/leadership-learning/leadership/resources/objective-and-subjective)‌ی معرفت‌شناسانه درست نیست، بنابراین لازم نیست به هیچ‌یک از آن‌ها اعتقاد داشت. آن کسی که وقتی می‌گویید "من" یا "منم" به آن اشاره می‌کنید، [درون‌آخته](/work/leadership-learning/leadership/resources/objective-and-subjective) است (فقط برای شما به طور مستقیم قابل دسترسی است و نه هیچ کس دیگر).
...
من و شما مکان [درون‌آخته](/work/leadership-learning/leadership/resources/objective-and-subjective)‌ی تازه‌ای در زندگی خلق کردیم، و نام آن مکان جدید را "اینجا۔ بیرون" گذاشتیم. ما نشان دادیم که شما در واقع قادر هستید [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) باشید، یعنی شما می‌توانید در جایی باشید که زندگی عملاً اتفاق می‌افتد. و به شما فرصتی دادیم تا خودتان برای خودتان کشف کنید، که می‌توانید در واقع [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) باشید، یعنی در جایی که دیدن شما (و بقيه‌ی ادراکات‌تان از زندگی) عملاً اتفاق می‌افتد.
...
همه‌ی ما به طور اتوماتیک باور داریم که درون-اینجا هستیم، پس لازم است برای مدتی، هر از گاهی در طول روز مکث کنید و عملاً با تجربه‌تان در آن لحظه ارتباط نزدیک برقرار کنید، که چیزی که با آن مواجه هستید، توسط شما [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) تجربه می‏‌شود. به خصوص، بسیار مهم است که این کار را زمانی انجام دهید که آنچه با آن مواجه هستید، فرد دیگری است.

اگر در چند ماه آینده، چند بار در روز { mark \ عملاً تمرین کنید که به جایی که تجربه‌تان از مشاهده و دریافت زندگی واقعاً اتفاق می‌افتد توجه کنید، خودتان را تعلیم خواهید داد که [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) باشید و زندگی کنید. }
...
در همین حال که من صحبت می‌کنم، شما چیزی را که من می‌گویم به عنوان اتفاقی در گوش‌های‌تان نمی‌شنوید. شبیه به تجربه وِزوِز گوش‌های‌تان نیست. جایی که گوش‌دادن‌ شما به حرف‌های من اتفاق می‌افتد، جایی است که من هستم و شما با [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) بودن، آن را در جایی که من هستم، می‌شنوید.

با تمرین‌کردن، خواهید دید که عملاً شروع می‌کنید به زندگی‌کردنِ [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here)، یعنی جایی که زندگی عملاً اتفاق می‌افتد.

وقتی دارید [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) بودن را تمرین می‌کنید، آنچه در درون‌تان می‌گذرد، دیگر آن کسی که برای خودتان هستید، نخواهد بود. در نتیجه، بسیار کمتر به آنچه در درون‌تان می‌گذرد توجه می‌کنید و بسیار کمتر توسط آن اذیت می‌شوید. و شما (آن شمایی که وقتی می‌گویید «من» یا «منم» به آن اشاره می‌کنید)، صرفاً یکی از چیزهایی خواهید بود که در عرصه‌ی روشنگاهی که ممکن است شما عملاً باشید، ظهور پیدا می‌کند.
...
در نتیجه‌ی تمرینِ بودنِ [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here)، کم‌کم در زندگی اثرگذارتر خواهید شد، و کیفیت بالاتری از زندگی را تجربه خواهید کرد. شما کشف خواهید کرد نسبت به آن کسی که می‌دانستید هستید، قدرت بیشتری دارید.

در حین انجام این تمرین، برای‌تان آشکار خواهد شد که کسی که شما هستید عرصه‌ی روشنگاهی است که زندگی در آن ظهور پیدا می‌کند. و اگر این تمرین را چند بار در روز انجام دهید، پس از مدتی - برای بعضی‌ها یک ماه و یا شاید دو ماه و برای بعضی‌های دیگر مدتی طولانی‌تر - شما به‌صورت طبیعی، خودتان را در زندگی، [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) خواهید یافت. [بیرون-اینجا](/work/leadership-learning/leadership/resources/out-here) بودن، تمرین مراقبه در دنیای بیرون است، به ‌جای آنکه این کار در اتاق مراقبه انجام شود. به بیان دیگر، تمرینِ مراقبه در گرداب زندگی است.

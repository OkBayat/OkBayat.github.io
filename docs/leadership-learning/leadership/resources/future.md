...
parent: Resources
direction: rtl
permalink: /work/leadership-learning/leadership/resources/future
---
...
همان‌طور که تاکنون باید تا حدی برای‌تان بدیهی شده باشد، آینده، [بافتمان](/work/leadership-learning/leadership/resources/context)ی برای زمان حال است. یا به بیان دقیق‏‌تر، آینده‌‏ای که فرد درون آن زندگی می‌‏کند، برای او [بافتمان](/work/leadership-learning/leadership/resources/context)ی برای زندگی‌کردن در زمان حال است. یعنی آنچه در زمانِ حال هست و همچنین امکان‌های موجود برای سروکار داشتن با آنچه که هست، هر دو برای آن فرد، در [بافتمان](/work/leadership-learning/leadership/resources/context) آینده‌ای که درون آن زندگی می‏‌کند، بافته می‌شود.

همان‌طور که قبلاً گفتیم، دنیا و طوری که کار می‏‌کند، دیگران، خودِ ما و طوری که آن‌ها و ما کار می‏‌کنیم، همگی برای ما در [بافتمان](/work/leadership-learning/leadership/resources/context)‌هایی بافته می‌شود که هم آنچه را که می‌‏توانیم از آن‌ها ببینیم و هم طوری که آنچه از آن‌ها می‌‏بینیم برای ‌ما بافته می‌شود را تحریف می‌کند.
...
اگر مأموریت ‏در [بافتمان](/work/leadership-learning/leadership/resources/context) آینده‌‏ای که توسط گذشته داده شده است محقق می‌شود، یعنی با فراخوانیِ گذشته محقق می‌شود (حتی اگر برای موفقیت، به چیزی بیشتر، بهتر یا متفاوت نیز نیاز باشد)، در این صورت برای محقق‌کردن آن مأموریت دیگر نیازی به راهبری نیست. مدیریت مؤثر مسلماً لازم خواهد بود، اما به راهبری نیازی نیست.

اگر [بافتمان](/work/leadership-learning/leadership/resources/context) جدیدی لازم است، یعنی اگر آینده‌‏ای فراتر از امکان‌‏هایی که توسط گذشته داده شده لازم است، یعنی اگر بیشتر، بهتر یا متفاوت انجام دادن کارها یا حتی ایجاد تغییراتی در آن‌ها برای تحقق موفقیت (برآورده‌کردن دغدغه‏‌های طرف‌های مرتبط) کافی نیست، در این صورت بدون راهبری هر کاری که انجام شود، نتیجه‌اش کاملاً موفقیت‏‌آمیز نخواهد بود.

بدون [بافتمان](/work/leadership-learning/leadership/resources/context)ی جدید، یعنی بدون "متحول‌کردن" آینده‌‏ای که شما و کسانی که راهبری‏شان می‏‌کنید در حال زندگی‌کردن درون آن هستید، آینده‏‌ای که محقق می‏‌شود باز همان خواهد بود. ممکن است بهتر یا متفاوت از گذشته باشد یا حتی تغییر کرده باشد، اما هر شکل دیگری هم که باشد، باز هم از همان گذشته خواهد بود.

یادتان باشد، [بافتمان](/work/leadership-learning/leadership/resources/context) قطعی است.

**نکته‏‌ای جداگانه درباره‌ی انواع مختلف [بافتمان](/work/leadership-learning/leadership/resources/context)**: قبلاً در این دوره، فرصتی در اختیارتان قرار دادیم تا به برخی از [بافتمان](/work/leadership-learning/leadership/resources/context)‌های فردی و خاص‏‌تان بپردازید و درباره‌ی آن‌ها صحبت کردیم. این [بافتمان](/work/leadership-learning/leadership/resources/context)‌های فردی و خاص، از جنبه‏‌هایی از جهان‏بینیِ معمول و روزمره و چارچوب‏‌های مرجع شما و محدودیت‏‌های هستی‌شناسانه‌تان تشکیل شده‏‌اند که همانند موانعی بر سر راه ابراز طبیعی شما عمل می‏‌کنند.

در مقابل، گفتگویی که اکنون درباره‌ی آینده به‌ عنوان [بافتمان](/work/leadership-learning/leadership/resources/context)ی برای زمان حال، و نه درباره‌ی [بافتمان](/work/leadership-learning/leadership/resources/context)‌های فردی و خاص شما در آن هستیم، در مورد آن نوع [بافتمان](/work/leadership-learning/leadership/resources/context)ی است که برای اینکه راهبر باشید و اِعمال مؤثر راهبری ابراز طبیعی‏تان باشد، باید در آن استادی پیدا کنید. این بخشی از چارچوبِ [بافتمان](/work/leadership-learning/leadership/resources/context) برای راهبر و راهبری است.

آنچه که تمام این موارد را تا این حد ناراحت‌کننده می‏‌کند، این واقعیت است که { mark \ [بافتمان](/work/leadership-learning/leadership/resources/context) فعلی، همان آینده‏ای است که افراد درون آن زندگی می‏‌کنند، و آینده‏‌ای که افراد درون آن زندگی می‏‌کنند، به طور پیش‌فرض از گذشته برگرفته شده و شکل گرفته است. }

یادتان باشد که [بافتمان](/work/leadership-learning/leadership/resources/context)، قطعی است. یعنی در [بافتمان پیش‌فرض](/work/leadership-learning/leadership/resources/context)، بودن و اَعمال افراد در زمان حال، باز هم منجر به همان چیزی می‏‌شود که قبلاً می‌شد. ممکن است بیشتر، بهتر یا متفاوت باشد یا حتی تغییر کند، اما باز هم شکل دیگری از گذشته است.

...
همان‌طور که تاکنون باید تا حدی برای‌تان بدیهی شده باشد، آینده، [بافتمان](/leadership/resources/context)ی برای زمان حال است. یا به بیان دقیق‏‌تر، آینده‌‏ای که فرد درون آن زندگی می‌‏کند، برای او [بافتمان](/leadership/resources/context)ی برای زندگی‌کردن در زمان حال است. یعنی آنچه در زمانِ حال هست و همچنین امکان‌های موجود برای سروکار داشتن با آنچه که هست، هر دو برای آن فرد، در [بافتمان](/leadership/resources/context) آینده‌ای که درون آن زندگی می‏‌کند، بافته می‌شود.

همان‌طور که قبلاً گفتیم، دنیا و طوری که کار می‏‌کند، دیگران، خودِ ما و طوری که آن‌ها و ما کار می‏‌کنیم، همگی برای ما در [بافتمان](/leadership/resources/context)‌هایی بافته می‌شود که هم آنچه را که می‌‏توانیم از آن‌ها ببینیم و هم طوری که آنچه از آن‌ها می‌‏بینیم برای ‌ما بافته می‌شود را تحریف می‌کند.

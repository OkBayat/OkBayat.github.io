...
parent: Resources
direction: rtl
permalink: /leadership/resources/objective-and-subjective
---
...
{: .no_toc }
{ mark \برای راهبربودن و اِعمال مؤثر راهبری، اگر قصد دارید که آن را به‌ عنوان ابراز طبیعی خودتان انجام دهید، لازمه‏‌اش این است که در [قلمروی گفتگویی](/leadership/resources/conversational-domain)‌ استادی پیدا کنید که شما را در دنیای واقعیت، درون‌گود قرار می‏‌دهد }؛ یعنی واقعیت، طوری که واقعاً در آن زندگی می‌‏شود و در لحظه بر روی آن کار می‌‏شود.

در هر موقعیت راهبری، این واقعیتی است که با آن مواجه خواهید شد، و از آن جا به‌ عنوان یک دنیا، باید عمل کنید تا یک پیامد موفق ایجاد کنید؛ پیامدی که هرگز، یا حداقل در حالِ معمولِ ما برای آن واقعیت، قرار نبود اتفاق بیافتد. برای آنکه این اتفاق بیافتد، شما باید در [قلمروی گفتگویی](/leadership/resources/conversational-domain)‌ای استادی پیدا کنید، که به طور طبیعی شما را در دنیای آن واقعیت قرار دهد.
...
همان گونه که پروفسور سِرل در نقل قولش در اسالید قبلی گفت: "معرفت شناسانه"معنایش این است که با دانش سروکار دارد (ادعاهایی درباره‌ی واقعیت و ناواقعیت) و "[هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology)" معنایش سروکار داشتن با وجود است (ساده تر بگوییم: چیزی که وجود دارد).

## برون آخته‌ی هستی‌شناسانه / درون آخته‌ی هستی‌شناسانه
برون آخته‌ی معرفت شناسانه و درون آخته‌ی معرفت شناسانه در مقابل برون آخته‌ی [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) و درون آخته‌ی [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology)

همان گونه که همواره گفته‌ایم، ما برون آخته‌ی معرفت شناسانه و درون آخته‌ی معرفت شناسانه داریم، همان گونه هم برون آخته‌ی [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) و درون آخته‌ی [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) داریم.

معرفت شناسانه درباره‌ی دانستن است (در واقع درباره‌ی ادعاهایی در مورد واقعیت و ناواقعیت).

[هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) درباره‌ی چیزی است که وجود دارد (یا هستی).

چیزی که برون آخته‌ی [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) باشد چیزی است که وجود دارد بدون اینکه آگاهی‌ای در مورد آن وجود داشته باشد.

چیزی که درون آخته‌ی [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) باشد چیزی است که در خودآگاهی شما (در ذهنیت شما) وجود دارد.

حالا درد شدید پایتان یا عشقتان به همسرتان می‌تواند وجود داشته باشد و همان طور که هست می‌تواند به صورت [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) واقعی باشد.
...
چیزی که به صورت [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) برون آخته باشد، چیزی است که وجود دارد، بدون نیاز به هرگونه آگاهی درباره‌ی آن.

چیزی که به صورت [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) درون آخته باشد، آن چیزی است که در آگاهی شما وجود دارد (در ذهنیت شما).

حالا درد شدید پایتان یا عشق‌تان به همسرتان می‌تواند وجود داشته باشد و همان طور که هست می‌تواند، به صورت [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology)، واقعی باشد.
...
3. **درون‌آخته [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology)** (Ontologically Subjective): چیزهایی که در آگاهی یا هویت فردی وجود دارند، مانند درد شدید در پا یا عشق به همسر.
...
7. **برون‌آخته [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology)** (Ontologically Objective): چیزهایی که وجود دارند بدون نیاز به هویت یا آگاهی از آن‌ها.
   چیزهایی مانند سنگ‌ها یا درختان، که وجود دارند بدون نیاز به هویت یا آگاهی از آن‌ها، برون‌آخته [هستی‌شناسانه](/leadership/resources/ontology-and-phenomenology) هستند.

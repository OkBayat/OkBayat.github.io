...
parent: Resources
direction: rtl
permalink: /leadership/resources/out-here
---
...
شاید در واقعیت درون‌آخته‌ی هستی‌شناسانه، شما [عرصه‌ی روشنگاهی](/leadership/resources/clearing) هستید، که جهان، در آن می‌تواند باشَ‌د. این موضوع در مقابل واقعیتِ برون‌آخته‌ی معرفت‌شناسانه است که جهان، خیلی بدیهی وجود دارد.
...
### راه حل این معما
شاید کسی که شما واقعاً هستید یک [عرصه‌ی روشنگاه](/leadership/resources/clearing)، یا فضایی است که در آن X و درکنار آن، همه‌ی باقیِ زندگی ظهور پیدا می‌کند - شامل آن چیزی که شما "من یا منم" می‌نامید.
...
در هر حال، آن کسی که وقتی می‌گویید "من" یا "منم" به آن اشاره می‏کنید، با همه‌ی باقیِ زندگی، همه و همه، قطعاً داخل آن [عرصه‌ی روشنگاهی](/leadership/resources/clearing) برای زندگی، که شما در واقع هستید، ظهور پیدا می‏کند.


### بیرون - اینجا
زندگی‌کردنِ واقعی، بیرون-اینجا اتفاق می‌افتد؛ جایی که زندگی عملاً، به‌ شکل زیستن رخ می‌دهد، جایی که زندگی عملاً اتفاق می‌افتد.

به عنوان آنچه زیسته می‌شود، شما [عرصه‌ی روشنگاهی](/leadership/resources/clearing) هستید که دنیا، دیگران و شمایی که وقتی می‌گویید "من" یا "منم" به آن اشاره می‌کنید، در آن برای‌تان ظهور پیدا می‌کند. و برای آن‌که به نقطه‌ای برگردیم که این صحبت را از آنجا شروع کردیم، اَعمال شما در آن [عرصه‌ی روشنگاه](/leadership/resources/clearing)، با طوری که آنچه در آن [عرصه‌ی روشنگاه](/leadership/resources/clearing) برای‌تان بافته می‌شود، همبسته است.

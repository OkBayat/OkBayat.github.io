...
این رابطه بین عمل و بافته شدن، به صورت رقصیدن با یکدیگر، شیوه‌ای است برای بیان ماهیت آنچه که از همبستگی عمل و بافته شدن مدنظر است —_به طور طبیعی، ضرورتاً به طور نزدیکی متصل (ظهور متقابل)_. به اختصار، متصل با یک همبستگی "رقصیدن با".
...
#### ۳. سومین جنبه: شیوه‌ای که شرایط برای اجراکننده بافته می‌شود (ظهور پیدا می‌کند) گاهی در زبان شکل می‌گیرد و در غیر این صورت، حداقل توسط زبان شکل می‌گیرد و در هر صورت همیشه از طریق زبان قابل دسترسی است.
...
اگر اکنون بپذیریم که بافته ‌می‌شود —شیوه‌ای که شرایطی که یک اجراکننده بر روی آن اجرا می‌کند برای اجراکننده بافته می‌شود، و شرایطی که یک اجراکننده در درون آن اجرا می‌کند برای اجراکننده بافته می‌شود، از جمله شیوه‌ای که اجراکننده برای خودش بافته می‌شود— گاهی اوقات در زبان تشکیل شده (constituted) و اگر این گونه نباشد، حداقل توسط زبان شکل می‌گیرد (shaped)، به نظر می‌رسد که زبان این قدرت را دارد که شیوه‌ی بافته شدنی را که با آن عملکرد همبسته است برای اجراکننده تغییر دهد.

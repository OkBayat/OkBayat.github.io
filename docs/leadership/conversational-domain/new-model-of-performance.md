...
#### ۴. 4. جنبه چهارم: در حالی که ما معمولاً زبان را به عنوان ابزاری برای ارتباط (نمایش دقیق یا نادرست جهان، و شامل صحبت با خودمان به صورت فکر کردن به کلمات) می‌دانیم، در واقع یک کاربرد زبان وجود دارد که نحوه‌ی بافتن شرایطی که یک اجراکننده در آن اجرا می‌کند را تغییر می‌دهد (ظاهر می‌شود) برای اجراکننده.[^72]

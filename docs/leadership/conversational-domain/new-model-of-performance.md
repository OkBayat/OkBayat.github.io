...
نتیجه می‌گیرد که وقتی از طریق استفاده از زبان، وقوع تغییر کند، اقدام همبسته (و در نتیجه عملکرد) تغییر می‌کند.
دسترسی عملی به منبع عملکرد که توسط مدل جدید عملکرد ما فراهم شده است - که اقدام یک همبستگی طبیعی با نحوه‌ای که شرایط برای اجراکننده رخ می‌دهد است، و اینکه نحوه‌ای که شرایط برای اجراکننده رخ می‌دهد از طریق زبان قابل دسترسی است - دنیایی از فرصت‌ها را برای مطالعه و تحقیق، و برای مداخلات، کاربردها و شیوه‌های جدید و مؤثرتر برای بهبود عملکرد باز می‌کند.

...
علاوه بر این، درک مفهوم درهم‌تنیدگی نشان می‌دهد که دو ذره درهم‌تنیده در واقع به طور طبیعی، ضروری و مستقیماً مرتبط هستند (همبسته‌اند). و این همبستگی، نه علت/معلول، منبع عمل (حالت) ذره دوم درهم‌تنیده است. دیدن این مسئله باعث می‌شود که بهتر متوجه شویم وقتی می‌گوییم منبع عمل همبستگی آن با نحوه بافته شدن شرایط است، منظورمان چیست. ما اذعان می‌کنیم که به دلیل جهان‌بینی علت/معلولی عادی و متداول، صحبت کردن درباره منبع عمل و نه علت عمل می‌تواند تا حدی گیج‌کننده باشد.
...
نتیجه‌گیری واضح از این واقعیت این است که توضیح مدل عملکرد فعلی درباره اقدام به عنوان نتیجه‌ای از علت —در این مورد، ویژگی داخلی «جنایتکاری»— حتی برای توضیح کاهش نرخ جرم از طریق تعمیر پنجره‌های شکسته کار نمی‌کند و مطمئناً برای روشن کردن منبع این کاهش در نرخ جرم کار نمی‌کند.

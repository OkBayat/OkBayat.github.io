...
[^36]: هارولد گارفینکل و آلوه نوه هر دو به نحوه‌ای که اجراکننده در شرایطی که در آن‌ها اجرا می‌کند درگیر و در نهایت بخشی از آن‌ها است، اشاره می‌کنند:<br/>«.
.. افراد، در جریان یک دوره از اقدامات، ماهیت موقعیت‌هایی را که در آن‌ها عمل می‌کنند کشف می‌کنند و اقدامات خود بازیگر اولین تعیین‌کننده‌های حس موقعیت‌ها هستند، که به معنای واقعی کلمه بازیگران خود را در آن‌ها می‌یابند.» (گارفینکل 1991، صفحات 114-115)<br/>
...
[^38]: به گفته داماسیو (1999، ص. 9)، منظور از تصویر: «... یک الگوی ذهنی در هر یک از حالت‌های حسی، به عنوان مثال، یک تصویر صوتی، یک تصویر لمسی، تصویر حالت سلامتی. این تصاویر جنبه‌هایی از ویژگی‌های فیزیکی شیء را منتقل می‌کنند و ممکن است واکنش‌های دوست داشتن یا نداشتن نسبت به آن شیء، برنامه‌هایی که برای آن تدوین می‌شود یا شبکه روابط آن شیء با سایر اشیاء را نیز منتقل کنند.» منظور داماسیو از شیء: «... موجوداتی به تنوع یک شخص، یک مکان، یک ملودی، دندان‌درد، حالت خوشی ...»<br/>
"ذهن نمی‌تواند به این سرعت فکر کند؛ حتی در شرایط ایده‌آل، مغز حدود بیست میلی‌ثانیه نیاز دارد تا به یک محرک حسی پاسخ دهد.<br/>
...
[^40]: «علاوه بر این، هرچه که وفاداری ممکن باشد، الگوهای عصبی و تصاویر ذهنی متقابل به همان اندازه که از واقعیت بیرونی که منجر به ایجاد آن‌ها می‌شود، محصولات مغز هستند، نیز ساخته‌های مغز به شمار می‌روند.» (داماسیو ۱۹۹۹، ص. ۳۲۰)<br/>
...
[^41]: برای مثال‌هایی از ۱) شکل‌های مولر-لایر، ۲) نابینایی به تغییرات، و ۳) نابینایی توجهی، به موارد زیر مراجعه کنید:<br/>
1. [http://www.michaelbach.de/ot/sze_muelue/index.html](http://www.michaelbach.de/ot/sze_muelue/index.html) (accessed 29 June 2010)<br/>
2. [http://www.youtube.com/watch?v=38XO7ac9eSs](http://www.youtube.com/watch?v=38XO7ac9eSs) (accessed 29 June 2010)<br/>
3. [http://www.youtube.com/watch?v=0AwwlJtnwA8](http://www.youtube.com/watch?v=0AwwlJtnwA8) (accessed 29 June 2010)

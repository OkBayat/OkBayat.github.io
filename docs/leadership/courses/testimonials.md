...
nav_order: 7
nav_exclude: true
description: "روایت‌های شخصی و خودگزارش‌شده‌ی شرکت‌کنندگان دوره‌های راهبری و چیرگی بر زندگی، همراه با توضیح محدودیت‌های این نوع شواهد."
permalink: /leadership/courses/testimonials
---

# تجربه‌های گزارش‌شده‌ی شرکت‌کنندگان

{ پاسخ شرکت‌کنندگان به این پرسش که تجربه‌ی آن‌ها از حضور در دوره چگونه بوده است | fs-6 }

{: .warning-title }
> درباره‌ی این روایت‌ها
>
> متن‌های زیر تجربه‌های شخصی و خودگزارش‌شده‌اند. آن‌ها شواهد کنترل‌شده‌ی علّی، ارزیابی بالینی، تضمین نتیجه یا اثبات ماندگاری تغییر نیستند. روایت‌های قابل‌شناسایی فقط باید با اجازه‌ی روشن منتشر شوند و صاحب روایت باید بتواند درخواست اصلاح یا حذف کند. برای چنین درخواستی می‌توانید با **me@OkBayat.com** تماس بگیرید.

ممکن است تجربه‌ی افراد دیگر، از جمله افرادی که تغییر خنثی، محدود یا نامطلوبی داشته‌اند، در این مجموعه نمایندگی نشده باشد. برای توضیح بیشتر درباره‌ی وضعیت شواهد، [سابقه‌ی برنامه‌ی چیرگی بر زندگی](/human-transformation/practice-programs/mastery-for-life) را ببینید.
...
_"شرکت توی این دوره برای من مثل یه اچارفرانسه است. اینکه فکر میکنم یه وسیله‌ای برای وقتی که نمیدونم چیکار کنم ... به نظرم کلا { این دوره ساده و قابل انجام تر هست،ِ یه جورایی به دل می‌شینه و درکش هم ساده و روون. | dark-mark } یه روش های عملی و قابل انجام و ساده و روون رو بیان میکنه."_  

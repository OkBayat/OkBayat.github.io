---
layout: default
title: K2-Kids as a Field Project in Independent Learning
description: "A practice-based record of K2-Kids and the questions it raises about children's autonomy, peer teaching, group coordination, and facilitator withdrawal."
...
sitemap: true
permalink: /human-transformation/field-projects/k2-kids
---

# K2-Kids as a Field Project in Independent Learning
{: .no_toc }

{ Field Project Record · Active · Longitudinal practice-based observation | fs-6 }

K2-Kids began as a small programming activity and became a setting for a broader question: can children learn to coordinate, continue learning, and teach others without remaining dependent on a central adult instructor?

This page records the project history as I currently understand it. It separates what was done and observed from what I think those observations may mean. It does not present K2-Kids as a controlled experiment or claim that the program alone caused the changes described here.
...
The operational description of the initiative is available on the [K2-Kids page](https://k2group.tech/subsidiaries/k2-kids).
...
- K2-Kids caused a permanent change in identity or learning ability;
...
This project contributes to the broader [Human Transformation Research Agenda](/human-transformation/research-agenda), especially the questions about context-dependent performance, children's ownership of learning, peer teaching, group coordination, and what remains after a facilitator leaves.

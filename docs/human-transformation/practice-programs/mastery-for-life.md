...
برخی شرکت‌کنندگان درباره‌ی تغییر در رابطه، نگاه به گذشته، شیوه‌ی مواجهه با خشم، امکان گفت‌وگو، احساس مسئولیت یا معنای زندگی نوشته‌اند. این روایت‌ها برای فهم تجربه‌ی زیسته‌ی افراد ارزش دارند و در صفحه‌ی [تجربه‌های گزارش‌شده‌ی شرکت‌کنندگان](/leadership/courses/testimonials) نگهداری می‌شوند.

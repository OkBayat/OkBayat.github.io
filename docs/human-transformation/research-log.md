...
nav_order: 7
direction: ltr
description: "A dated log of changes to questions, field projects, evidence standards, interpretations, and publishing decisions."
permalink: /human-transformation/research-log
---

# Human Transformation Research Log

This log records material changes in the inquiry. It is not a diary of every activity; it is a trace of revisions that affect questions, methods, evidence, privacy, or public claims.

## July 17, 2026 — Program Defined
...
- Detailed legacy leadership pages were moved out of the global sidebar while remaining accessible through section hubs and search.
...
A log entry should state:

1. what changed;
2. why it changed;
3. what evidence or observation informed the change;
4. what was not resolved;
5. which pages or methods need revision next.

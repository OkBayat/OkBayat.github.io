...
این پرسش از دل یادداشت قبلی من درباره‌ی [تعهد به‌مثابه بافتار یادگیری](/research/notes/commitment-context-learning-fa) بیرون آمد، اما موضوع این نوشته با آن متفاوت است. در آن تجربه دیدم وقتی یادگیرنده متوجه می‌شود واقعاً به چه چیزی متعهد است—فهمیدن، برنامه‌ریزی، تلاش کردن یا تحقق یک نتیجه—نحوه‌ی حضور و عملش ممکن است تغییر کند. بعد پرسش دیگری برایم شکل گرفت:

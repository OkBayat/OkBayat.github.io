...
[صفحه‌ی «شیوه‌ی بودن» در OkBayat.com](https://www.okbayat.com/leadership-learning/leadership/resources/way-of-being) همین تعریف را در زبان فارسی حفظ می‌کند. این وفاداری مهم است، زیرا اجازه می‌دهد میان سه سطح فرق بگذاریم: بدن و عاطفه و فکرِ اکنون؛ بافتمانی که موقعیت از خلال آن [بافته می‌شود](https://www.okbayat.com/leadership-learning/leadership/resources/context)؛ و ساختار وجودیِ هستی‌ـ‌درـ‌جهان که هایدگر تحلیل می‌کند. این سه با هم نسبت دارند، اما یکی نیستند.

نویسندگان مدل می‌گویند شیوه‌ی بودن و شیوه‌ی عمل‌کردن با نحوه‌ای که موقعیت برای شخص رخ می‌نماید، هم‌آیندند. تعبیر دقیق‌تر **همبستگی و هم‌پدیداری** است، نه علت مکانیکی. اگر مدیر در بدن منقبض، در عاطفه ترسان، در ذهن دفاعی و در فکر مشغولِ «نباید ضعیف به نظر برسم» باشد، جلسه ممکن است عرصه‌ی تهدید بافته شود و سکوت یا کنترل‌گری طبیعی جلوه کند. قرار نیست از این مثال نتیجه بگیریم هر عمل را می‌توان فقط از حالت درونی توضیح داد؛ ساختار قدرت، منابع، مهارت و تاریخ نیز واقعی‌اند. مزیت مدل آن است که سطحی از دسترسی عملی را نشان می‌دهد: می‌توان [بافتمان](https://www.okbayat.com/leadership-learning/leadership/resources/context)، [گوش‌دادن ازقبل‌همیشه](https://www.okbayat.com/leadership-learning/leadership/resources/already-always-listening) و نحوه‌ی رخ‌نمودن موقعیت را متمایز کرد و سپس عمل را دوباره آزمود.
...
این تمایز با [«مدل جدید عملکرد»](https://www.okbayat.com/leadership-learning/leadership/resources/new-model-of-performance) پیوند دارد. در مقاله‌ی کاری ارهارد، جنسن و گروه باربادوس، منبع نزدیکِ عمل در نحوه‌ی رخ‌نمودن یا «بافته‌شدن» آن چیزی جست‌وجو می‌شود که فرد با آن سروکار دارد؛ و زبان راه دسترسی به این رخ‌نمود است ([Erhard, Jensen, & Barbados Group, 2010](https://doi.org/10.2139/ssrn.1437027)). این مدل، چنان‌که خود چکیده نیز نشان می‌دهد، پارادایمی مفهومی و برنامه‌ای برای پژوهش آینده است. درج آن در مجموعه‌ی مقالات کاری دانشگاه هاروارد به معنای داوری همتای متعارف، تأیید نهادی یا اثبات تجربی نیست.

از این منظر، اصطلاحات سایت یک شبکه‌ی گفت‌وگویی می‌سازند، نه فهرستی از تعریف‌های جدا:

| تمایز | کارکرد در راهبری | سوءبرداشت محتمل |
|---|---|---|
| [شیوه‌ی بودن](https://www.okbayat.com/leadership-learning/leadership/resources/way-of-being) | دیدن آرایش ذهنی، عاطفی، بدنی و فکریِ حاضر | تیپ شخصیتی یا ذات ثابت |
| [بافتمان](https://www.okbayat.com/leadership-learning/leadership/resources/context) | دیدن لنزی که موقعیت از خلال آن معنا می‌گیرد | داستان خیالیِ بی‌ارتباط با واقعیت |
| [گوش‌دادن ازقبل‌همیشه](https://www.okbayat.com/leadership-learning/leadership/resources/already-always-listening) | متمایزکردن فیلترهای تاریخی و جمعیِ شنیدن | امکان رسیدن به گوش‌دادن کاملاً بی‌پیش‌فرض |
| [قلمرو گفتگویی](https://www.okbayat.com/leadership-learning/leadership/resources/conversational-domain) | ساختن شبکه‌ی تمایزهایی که یک جهانِ عمل را باز می‌کند | حفظ‌کردن واژه‌های تخصصی |
| [آینده](https://www.okbayat.com/leadership-learning/leadership/resources/future) | دیدن آینده‌ی پیش‌فرض و ایستادن برای آینده‌ای خلق‌شده | پیش‌بینی خوش‌بینانه یا انکار محدودیت |
| [اصالت](https://www.okbayat.com/leadership-learning/leadership/resources/authentic) | راست‌کردن رابطه با غیراصیلی، پنهان‌کاری و تصویری که حفظ می‌کنیم | بیان تکانه‌ای هر احساس یا «خود واقعی» ثابت |
| [یکپارچگی](https://www.okbayat.com/leadership-learning/leadership/resources/integrity) | کامل‌بودن کلام و بازیابی اعتماد و کارایی | مترادف‌گرفتن با اخلاق یا بی‌خطابودن |
...
| ۲. آشکارسازی بافتمان | موقعیت در چه [بافتمانی](https://www.okbayat.com/leadership-learning/leadership/resources/context) برای من/ما بافته می‌شود؟ | نام‌گذاری جهان‌بینی، چارچوب مرجع و آینده‌ی پیش‌فرض | دست‌کم یک تفسیر بدیل واقعاً قابل دیدن می‌شود |
...
- [شیوه‌ی بودن](https://www.okbayat.com/leadership-learning/leadership/resources/way-of-being)
- [بافتمان](https://www.okbayat.com/leadership-learning/leadership/resources/context)
- [مدل جدید عملکرد](https://www.okbayat.com/leadership-learning/leadership/resources/new-model-of-performance)
- [گوش‌دادن ازقبل‌همیشه](https://www.okbayat.com/leadership-learning/leadership/resources/already-always-listening)
- [قلمرو گفتگویی](https://www.okbayat.com/leadership-learning/leadership/resources/conversational-domain)
- [آینده](https://www.okbayat.com/leadership-learning/leadership/resources/future)
- [اصالت](https://www.okbayat.com/leadership-learning/leadership/resources/authentic)
- [یکپارچگی](https://www.okbayat.com/leadership-learning/leadership/resources/integrity)
- [انتخاب](https://www.okbayat.com/leadership-learning/leadership/resources/choose)
- [هستی‌شناسی و پدیدارشناسی](https://www.okbayat.com/leadership-learning/leadership/resources/ontology-and-phenomenology)
- [مدل جدید راهبری](https://www.okbayat.com/leadership-learning/courses/a-new-model-of-leadership)

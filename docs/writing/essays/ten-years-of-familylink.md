...
tags:
  ...
  - entrepreneurship
sitemap: true
permalink: /writing/essays/ten-years-of-familylink
---

# Ten Years of FamilyLink: What We Built, Why It Paused, and What Remains
{: .no_toc }

{ Essay · A project reflection | fs-6 }

A project can help people and still fail.

That sentence is the most honest way I know to begin writing about FamilyLink. For approximately a decade, we put time, resources, relationships, and attention into supporting family stability. Practical goods were distributed. Caregivers received assistance. Some received training or support connected to work and income. The work reached a substantial number of people according to the records and recollections available to me, but I am intentionally not publishing unaudited totals.

The project also stopped. It did not become financially independent, its measurement was not strong enough, and too much of its continuity depended on one principal sponsor. When that support contracted, FamilyLink could no longer continue responsibly.
...
Some of the project's old language placed very different family and care circumstances under one emotional label. Over time, I came to see that this was imprecise. Different circumstances require different professional judgments, safeguards, and forms of support.

The practical intuition behind FamilyLink was narrower than some of our early promises: when material hardship is a major reason that a family is at risk of separation, support the caregiver and the household. That could include essential goods, practical assistance, training, or livelihood-related support.
...
An existing organization provided resources, coordination, and infrastructure. Other people and organizations contributed capabilities or materials. Families and caregivers received different forms of support depending on the period and the circumstances.

One visible activity was the distribution of essential goods, including clothing. It was carried out at meaningful scale with help from external collaborators. I am not naming beneficiaries, individual cases, locations, or collaborators in this public reflection.

The work also included support for caregivers. Some received training, livelihood-related support, or direct assistance. The goal was not only to give something once, but to create conditions in which a caregiver could become more economically capable.
...
Earlier FamilyLink material published precise cumulative reach figures. I am not repeating them here as audited facts. The surviving public record does not explain its method well enough for me to show, in one reviewed dataset:
...
What I can say with confidence is more modest: the project operated for approximately a decade, reached a substantial number of children and caregivers, delivered practical support at meaningful scale, supported caregiver capacity, and used significant human and material resources.
...
FamilyLink was connected to an existing organization from the beginning. That connection was a source of strength.
...
FamilyLink did not develop enough independent funding. It did not have a protected reserve or a diversified group of funders. Its governance and operating capacity were not sufficiently separate from its principal sponsor. As long as that sponsor could support the project, the structure appeared workable. When its capacity declined, the weakness became visible.

This is a familiar entrepreneurial error: confusing access to a resource with ownership of a durable system.

For years, access to an existing organization's resources made FamilyLink possible. It did not make FamilyLink financially independent.

## Why We Stopped

The immediate pause came during a difficult financial period when the principal sponsor could no longer carry the same level of support. It would be easy to describe that external change as the cause of the project's failure. That would be incomplete.
...
Older material made universal promises about keeping children in family settings. The moral direction was understandable. The promise was larger than our evidence, authority, and operational capacity.
...
Existing infrastructure and collaborative relationships allowed FamilyLink to act. Future work should still look for ways to use existing production, software, logistics, professional, and organizational capacity rather than rebuilding everything from zero.
...
1. a limited pilot with a defined location, population, period, and service scope;
2. independent and diversified funding;
3. a protected reserve and an explicit continuity or exit plan;
4. written governance, financial controls, and accountability;
5. child safeguarding, privacy, consent, complaint, and referral procedures;
6. partnerships with qualified social, legal, health, education, and child-protection professionals;
7. privacy-conscious records that distinguish people, households, services, and repeat support;
8. predeclared activity, outcome, and harm measures;
9. follow-up long enough to examine continuity rather than only immediate delivery;
10. publication of negative, incomplete, and inconclusive results.
...
- **July 23, 2026:** Generalized the public account and removed partner identities, unaudited totals, specific financial triggers, and unnecessary case-level detail.

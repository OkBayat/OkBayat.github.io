...
سوابق حرفه‌ای این سایت، این مشاهده‌ها را عمداً محدود نگه می‌دارند. [حلقه‌ی یادگیری](/work/leadership-learning/human-transformation/field-projects/learning-circle) حمایت همسالان و هماهنگی اولیه را در دوره‌ای که مستقیماً مشاهده شده ثبت می‌کند، اما پس از پایان حضور منظم تسهیل‌گر، ادعایی درباره‌ی خودمختاری پایدار ندارد. [چیرگی بر زندگی](/work/leadership-learning/human-transformation/practice-programs/mastery-for-life) گزارش‌های شرکت‌کنندگان و مشاهدات حرفه‌ای را نگه می‌دارد و هم‌زمان صریح می‌گوید که این مواد، علیت، تعمیم‌پذیری یا تحول دائمی را اثبات نمی‌کنند. یک [یادداشت میدانی اکتشافی](/research-practice/notes/what-remains-when-the-course-ends) و یک [پرس‌وجوی منبع‌محور درباره‌ی عمل تأملی](/research-practice/notes/can-the-learner-carry-the-context) نیز نشان می‌دهند این پرسش چگونه برای من شکل گرفته است.

...
parent: ساختار جادو
nav_order: 3
permalink: /writing/essays/the-structure-of-magic/chapter-1
direction: rtl
lang: fa
locale: fa_IR
---
...
نکته اینجاست که یک قاعده واحد بسته به [بافتمان](/work/leadership-learning/leadership/resources/context) ممکن است مفید یا غیرمفید باشد - یعنی هیچ تعمیم درستی وجود ندارد و هر مدل باید در [بافتمان](/work/leadership-learning/leadership/resources/context) خود ارزیابی شود. علاوه بر این، این موضوع به ما کلیدی برای درک رفتار انسانی می‌دهد که به نظر ما عجیب یا نامناسب می‌آید - یعنی اگر بتوانیم رفتار فرد را در [بافتمان](/work/leadership-learning/leadership/resources/context)‌ای که در آن شکل گرفته ببینیم.
...
*حذف* به کاهش جهان به اندازه‌هایی که احساس می‌کنیم قادر به مدیریت آن‌ها هستیم کمک می‌کند. این کاهش ممکن است در برخی [بافتمان](/work/leadership-learning/leadership/resources/context)‌ها مفید باشد، اما در برخی دیگر منبع درد برای ما باشد.

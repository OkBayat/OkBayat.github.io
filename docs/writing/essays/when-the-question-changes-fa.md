...
tags:
  ...
  - خلق ارزش
sitemap: true
permalink: /writing/essays/when-the-question-changes-fa
---
...
{ [English version](/writing/essays/when-the-question-changes-en) | ltr }
...
تعهد فراتر از خود به این معنا نیست که فرد باید خود را در رابطه حذف کند یا هر آسیبی را تحمل کند. یک آینده‌ی مشترک بدون رضایت، ایمنی و مسئولیت مشترک ساخته نمی‌شود. گاهی دیدن واقعیت و حفظ کرامت، به معنای پایان دادن به رابطه است. در مقاله‌ی [پیش از تغییر، پذیرش](/writing/essays/acceptance-before-change-fa) درباره‌ی این مرز با جزئیات بیشتری نوشته‌ام.

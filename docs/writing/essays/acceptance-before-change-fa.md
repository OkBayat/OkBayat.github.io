...
این گزاره نیز برای تبدیل‌شدن به ادعایی قوی‌تر، به مشاهده و اندازه‌گیری دقیق‌تر در زمان‌ها و محیط‌های متفاوت نیاز دارد. بخشی از [برنامه‌ی پژوهشی تحول انسان](/research/agenda) من دقیقاً حول همین پرسش شکل گرفته است: چه چیزی از یک تغییر، بعد از عوض‌شدن بافتار باقی می‌ماند؟

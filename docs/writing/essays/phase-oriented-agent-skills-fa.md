...
tags:
  ...
  - بارگذاری تنبل
sitemap: true
permalink: /writing/essays/phase-oriented-agent-skills-fa
---
...
{ [English version](/writing/essays/phase-oriented-agent-skills-en) | ltr }
...
- [Building Effective Agents](https://www.anthropic.com/engineering/projects-effective-agents) — تمایز میان workflowهای ازپیش‌تعریف‌شده و agentهای با هدایت پویا، همراه با الگوهای routing، chaining، evaluator و orchestrator.

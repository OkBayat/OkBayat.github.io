...
Gem::Specification.new do |spec|
  ...
  spec.files         = `git ls-files -z ':!:*.jpg' ':!:*.png'`.split("\x0").select { |f| f.match(%r{^(assets|bin|_layouts|_includes|lib|Rakefile|_sass|THIRD-PARTY-NOTICES|README|CHANGELOG|favicon)}i) }
